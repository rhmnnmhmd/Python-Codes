...
for OmegaCArrayElement in OmegaCArray:
    ...
    if len(altMaxIndexArray) == 1:
        altMaxIndexFocus2 = midPointIndex + altMaxIndexArray[0]
        
        altMaxDetuning1 = 0
        altMaxDetuning2 = detuningArray[altMaxIndexFocus2]
        
    elif len(altMaxIndexArray) > 1:
        altMaxIndexFocus1 = midPointIndex + altMaxIndexArray[-2]
        altMaxIndexFocus2 = midPointIndex + altMaxIndexArray[-1]
...
#marker-line-color
ax.plot(OmegaCArrayNorm, SpecWidthAltMaxArray1/gamma31, "ok", label = "Data (Alt Type 1)")
ax.plot(OmegaCArrayNorm, SpecWidthAltMaxArray2/gamma31, "^k", label = "Data (Alt Type 2)")

#plot quartic curve-fitting
#ax.plot(OmegaCArrayNorm, curve_fit3, "-r", label = "Quartic Curve-Fit (Alt Type 1)")
#ax.plot(OmegaCArrayNorm, curve_fit4, "-b", label = "Quartic Curve-Fit (Alt Type 2)")
...
CS2 = ax.contour(X, Y, exactPhase2, [0], colors = "blue")
#ax.clabel(CS1, inline=1, fontsize=10)
#ax.clabel(CS2, inline=1, fontsize=10)
